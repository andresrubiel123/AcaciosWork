...
`;
        ...
        /** Notificación: loadReportesChart duplicado removido para usar la versión de ganancias-mensuales.js. @author RADJ */
...
document.getElementById('modal-form').addEventListener('submit', async (e) => {
    ...
    try {
        ...
        if (typeof showToast === 'function') {
            showToast('✅ ' + (editId ? 'Registro actualizado' : 'Registro creado') + ' exitosamente.', 'success');
        } else {
