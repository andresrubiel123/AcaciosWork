# Chatbot de Soporte con IA para AcaciosWork (Edición Forja-Starter)

Este es el **chatbot de soporte inteligente para Telegram** del ecosistema AcaciosWork, integrado con DeepSeek y desplegado en Cloudflare Workers. Responde dudas de usuarios y clientes del ERP de forma autónoma.
