...
const RATES: Record<string, Rates> = {
  ...
  // Gemini (Google) — aprox, revisar contra pricing oficial de Google AI.
  "gemini-2.5-flash-lite": { input: 0.10, cacheRead: 0.025, output: 0.40 },
  "gemini-2.5-flash": { input: 0.30, cacheRead: 0.075, output: 2.50 },
  "gemini-2.5-pro": { input: 1.25, cacheRead: 0.3125, output: 10.00 },
};
