...
const COSTS_CONFIG_PROMPT =
  "Configura el control de costos de mi bot de Forja: ayúdame a poner un tope de presupuesto mensual razonable (setting monthly_budget), y explícame cómo leer el gasto del mes y la proyección para no llevarme sorpresas.";
    ...
    <div class="card bg-panel border border-line p-[18px]">
      ...
      <div class="mb-[14px]" style="border-top:1px dashed var(--line);padding-top:14px">
        <p class="text-[11px] text-dim leading-relaxed mb-3">
          Esta tab rastrea <b class="text-muted">cuánto gasta tu bot en IA cada mes</b> (exacto, por tokens reales) y,
        ...
        ${renderConfigPrompt(COSTS_CONFIG_PROMPT)}
      </div>`
        : ""}
