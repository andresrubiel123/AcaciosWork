...
export const inmobiliaria: NichePack = {
  id: "inmobiliaria",
  accent: "#3f6fd8",
  recordSingular: "Comprador",
  recordPlural: "Compradores",
  navLabel: "Compradores",
  navIcon: "home",
  kpiLabel: "Compradores",
  // nuevo → calificado → cerrado → descartado (mapeados a los 4 canónicos).
  statusLabels: { new: "Nuevo", contacted: "Calificado", sold: "Cerrado", lost: "Descartado" },
  columns: [
    { key: "operacion", label: "Operación" },
    { key: "tipo", label: "Tipo" },
    { key: "zona", label: "Zona" },
    { key: "presupuesto", label: "Presupuesto" },
    { key: "recamaras", label: "Recám." },
  ],
