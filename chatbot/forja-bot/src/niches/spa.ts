...
export const spa: NichePack = {
  id: "spa",
  accent: "#35a98a",
  recordSingular: "Sesión",
  recordPlural: "Sesiones",
  navLabel: "Sesiones",
  navIcon: "flower-2",
  kpiLabel: "Sesiones",
  statusLabels: { new: "Solicitada", contacted: "Confirmada", sold: "Atendida", lost: "Cancelada" },
  columns: [
    { key: "ritual", label: "Ritual" },
    { key: "profesional", label: "Terapeuta" },
