...
export const DAILY_CAP_MESSAGE =
  "Me encanta la cuerda que tienes, pero soy la IA de Santi para temas de Horizontes IA y por hoy ya te acompañé un buen rato. Mañana seguimos si quieres. Y si lo tuyo es aprender de IA en serio, justo eso hacemos en la comunidad: https://horizontesia.com";
