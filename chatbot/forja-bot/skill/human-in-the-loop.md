...
callado AHÍ por un rato para que tú lo atiendas sin que el bot te pise. Eso es configurable:

- **Desde el panel**: Configuración → tarjeta **"Cuando tomas el control"** → elige
  **1 hora** (lo normal) · **3 horas** · **Hasta que reanude**.
- **O directo** (setting `takeover_minutes` en D1): minutos (`30`, `60`, `180`) o **`0` =
  no vuelve hasta que le des «Reanudar»**. Vacío = 60.
